...
//console.log(cityJson);
 ...
 getDataFromCatalystDataStore(catalystApp, fnameJson.FirstName).then(fnameDetails => {
  if (fnameDetails.length == 0) { // If the row is not present, then a new row is inserted
   console.log("First name missing!"); //Written to the logs. You can view this log from Logs under the Monitor section in the console 
   var rowData={}
